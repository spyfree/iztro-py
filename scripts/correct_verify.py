...
print(
    f"{'命宫地支':<20} {py_result.earthly_branch_of_soul_palace:<30} {iz_result.earthly_branch_of_soul_palace:<30}"
)
print(
    f"{'身宫地支':<20} {py_result.earthly_branch_of_body_palace:<30} {iz_result.earthly_branch_of_body_palace:<30}"
)
