...
def place_minor_stars(
    ...
    if zuofu_palace:
        zuofu_palace['minor_stars'].append(Star(
            name='zuofuMin',
            type='soft',
            scope='origin'
        ))
    ...
    if youbi_palace:
        youbi_palace['minor_stars'].append(Star(
            name='youbiMin',
            type='soft',
            scope='origin'
        ))
    ...
    if wenchang_palace:
        wenchang_palace['minor_stars'].append(Star(
            name='wenchangMin',
            type='soft',
            scope='origin'
        ))
    ...
    if wenqu_palace:
        wenqu_palace['minor_stars'].append(Star(
            name='wenquMin',
            type='soft',
            scope='origin'
        ))
    ...
    if kuai_palace:
        kuai_palace['minor_stars'].append(Star(
            name='tiankuiMin',
            type='soft',
            scope='origin'
        ))
    ...
    if yue_palace:
        yue_palace['minor_stars'].append(Star(
            name='tianyueMin',
            type='soft',
            scope='origin'
        ))
    ...
    if huo_palace:
        huo_palace['minor_stars'].append(Star(
            name='huoxingMin',
            type='tough',
            scope='origin'
        ))
    ...
    if ling_palace:
        ling_palace['minor_stars'].append(Star(
            name='lingxingMin',
            type='tough',
            scope='origin'
        ))
    ...
    if kong_palace:
        kong_palace['minor_stars'].append(Star(
            name='dikongMin',
            type='tough',
            scope='origin'
        ))
    ...
    if jie_palace:
        jie_palace['minor_stars'].append(Star(
            name='dijieMin',
            type='tough',
            scope='origin'
        ))
    ...
    if lucun_palace:
        lucun_palace['minor_stars'].append(Star(
            name='lucunMin',
            type='lucun',
            scope='origin'
        ))
    ...
    if yang_palace:
        yang_palace['minor_stars'].append(Star(
            name='qingyangMin',
            type='tough',
            scope='origin'
        ))
    ...
    if tuo_palace:
        tuo_palace['minor_stars'].append(Star(
            name='tuoluoMin',
            type='tough',
            scope='origin'
        ))
    ...
    if tianma_palace:
        tianma_palace['minor_stars'].append(Star(
            name='tianmaMin',
            type='tianma',
            scope='origin'
        ))
